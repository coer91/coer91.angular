import { Component, AfterViewInit, OnDestroy, viewChild, computed } from '@angular/core'; 
import { CoerSelectBox } from '@library/components';
...
export class CoerSelectboxPage implements AfterViewInit, OnDestroy {       
